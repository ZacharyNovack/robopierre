...
"2":{
    ...
    "audio":["https://cdn.glitch.com/32d49bb5-00eb-4105-853e-80c89fd9f764%2FplaceholderAudio.mp3?v=1588838393008"]
...
var about_text = "Website designed by Joseph Sandler and Zachay Novack."+
    " Sound synthesis by Zachary Novack with assistance from Joseph Sandler and Gabriel Garcia. Voices used: Joseph Sandler, Dr. Jocelyn Dueck, Gabriel Garcia" +
    ...
    "do this was generated using Google Magenta's Polyphony RNN on a corpus of piano works by Debussy, Ravel, and Chopin. Type <b>github</b> to be taken to the external github repo for this project."+
    ...
    "<p>Project under Creative Commons Attribution NonCommercial ShareAlike license. For more information type <b>license</b>. (Both links will take you to an external page)."
//
//
...
function do_console_command(input) {
  ...
  switch(input) {
      ...
      case("--"):
        ...
        break;
      case("license"):
        window.location.replace("https://creativecommons.org/licenses/by-nc-sa/4.0/");
        break;
      case("contribute"):
        window.location.replace("https://forms.gle/M4KJ4cv6tQjzt3kc8");
        break;
      case("play_promo"):
        window.location.replace("https://youtu.be/Crx-WI6c8h8");
        // sound.pause();
        ...
        break;
      case("github"):
        window.location.replace("https://github.com/ZacharyNovack/robopierre");
        break;
    default:
